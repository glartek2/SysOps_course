        ...
        switch (receive_message.type) {
            case INIT:
                ...
                if (id == MAX_CLIENTS_COUNT) {
                    printf("Maksymalna liczba klientów jest podłączona, nie można otworzyć kolejnego połączenia\n");
                    continue;
                }
                ...
                printf("Zarejestrowano połączenie z klientem pod identyfikatorem: %d\n", id);
                break;
            case MESSAGE_TEXT:
            ...
            case CLIENT_CLOSE:
                ...
                printf("Zamknięto połączenie z klientem pod identyfikatorem: %d\n", receive_message.identifier);
                break;
            default:
                printf("Nieoczekiwany typ komunikatu w kolejce serwera: %d \n", receive_message.type);
                break;
        }
    }
